...
const Home = () => {
  ...
  let fullName = `Welcome Supper Admin ${stateSuperAdmin[0].lastName}  ${stateSuperAdmin[0].firstName} to your dashboard`;

  return (
    <div>
      <Box >
        {/* HEADER */}
        <Box ml="40px" display="flex" justifyContent="space-between" alignItems="center">
